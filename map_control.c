...
/*   Updated: 2024/06/25 17:19:54 by eyasa            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	count_check(t_game *so_long)
{
	...
	{
		ft_printf("Error: There must be only one exit.\n");
		exit(1);
	}
	else if (so_long->c_count < 1)
	{
		ft_printf("Error: No item to collect.\n");
		exit(1);
	}
	else if (so_long->p_count != 1)
	{
		ft_printf("Error: There must be only one player.\n");
		exit(1);
	}
}
